...
## [0.13.0](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.12.0...tower-resilience-retry-v0.13.0) - 2026-08-21
...
- *(retry)* [**breaking**] validate backoff configuration ([#441](https://github.com/joshrotenberg/tower-resilience/pull/441))
- *(router)* preserve distribution across clones ([#401](https://github.com/joshrotenberg/tower-resilience/pull/401))
- *(retry)* implement TPS-based budget replenishment with atomic accounting (closes #370) ([#411](https://github.com/joshrotenberg/tower-resilience/pull/411))
...
- *(retry)* poll readiness before retry attempts ([#392](https://github.com/joshrotenberg/tower-resilience/pull/392))
- *(reconnect)* rebuild failed services from factory ([#391](https://github.com/joshrotenberg/tower-resilience/pull/391))

### Fixed

- Poll inner service readiness before every retry attempt and propagate readiness errors unchanged ([#362](https://github.com/joshrotenberg/tower-resilience/issues/362))

## [0.10.1](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.10.0...tower-resilience-retry-v0.10.1) - 2026-07-27

### Added

- *(retry)* relax E: Clone bound on retry Service impl ([#350](https://github.com/joshrotenberg/tower-resilience/pull/350))

## [0.10.0](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.9.4...tower-resilience-retry-v0.10.0) - 2026-06-10
...
## [0.9.4](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.9.3...tower-resilience-retry-v0.9.4) - 2026-05-13
...
## [0.9.2](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.9.1...tower-resilience-retry-v0.9.2) - 2026-03-08
...
## [0.9.1](https://github.com/joshrotenberg/tower-resilience/compare/tower-resilience-retry-v0.9.0...tower-resilience-retry-v0.9.1) - 2026-03-08
